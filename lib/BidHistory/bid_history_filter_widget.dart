...
export 'bid_history_filter_model.dart';

class BidHistoryFilterWidget extends StatefulWidget {
  const BidHistoryFilterWidget({super.key});

  @override
  State<BidHistoryFilterWidget> createState() => _BidHistoryFilterWidgetState();
}

class _BidHistoryFilterWidgetState extends State<BidHistoryFilterWidget>
  ...
  Future<List<Bid>> acceptBids() async {
    ...
    try {
      final uri = Uri.parse(ApiService.driverAcceptedBids);
      final response = await http.post(uri, body: {'d_id': dId.toString()});
                  ...
                  children: [
                    Align(
                      ...
                      child: TabBar(
                        ...
                        labelStyle: context.appTheme.titleSmall.override(
                          fontFamily: 'Open Sans',
                          letterSpacing: 0,
                        ),
