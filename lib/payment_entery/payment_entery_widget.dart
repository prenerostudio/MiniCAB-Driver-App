...
class _PaymentEnteryWidgetState extends State<PaymentEnteryWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(Duration(seconds: 4), () {
        setState(() {
          watingController?.text = '${Waiting ?? '0'}'; // Replace 'Waiting' with your actual value
        });
      });
    });
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(Duration(seconds: 4), () {
        setState(() {
         tollsController?.text = '${Tolls ?? '0'}'; // Replace 'Waiting' with your actual value
        });
      });
    });
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(Duration(seconds: 4), () {
        setState(() {
          parkingController?.text = '${CarParking ?? '0'}'; // Replace 'Waiting' with your actual value
        });
      });
    });
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(Duration(seconds: 4), () {
        setState(() {
          extraWaitingController?.text = '${Extra ?? '0'}'; // Replace 'Waiting' with your actual value
        });
      });
    });
  }
    ...
    if (response.statusCode == 200) {
      ...
      if (parsedResponse['data'] is List) {
        if (parsedResponse.containsKey('data')) {
         ...
         print(CarParking); print( Waiting); print(Tolls); print(Extra);
        }
  ...
  Future<void> addFares() async {
    try {
      ...
      var request = http.MultipartRequest('POST', Uri.parse('https://www.minicaboffice.com/api/driver/add-fares.php'));
