...
class _UpcommingjobWidgetState extends State<UpcommingjobWidget> with TickerProviderStateMixin{
  ...
  Future<List<Job>> jobDetailsNextWeek() async {
    ...
    String? dId = prefs.getString('d_id');
    final response = await http.post(
      Uri.parse('https://www.minicaboffice.com/api/driver/upcoming-next-week.php'),
      body: {
        'd_id': dId.toString(),
      },
    );
                                  ...
                                  child: FutureBuilder<List<Job>>(
                                    ...
                                    builder: (BuildContext context,
                                      ...
                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                        ...
                                        return Center(child: Text('No Job is Available.'));
                                      } else {
