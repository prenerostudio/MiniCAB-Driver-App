...
class VehicleInsuranceWidget extends StatefulWidget {
  const VehicleInsuranceWidget({super.key});

  @override
  State<VehicleInsuranceWidget> createState() => _VehicleInsuranceWidgetState();
}

class _VehicleInsuranceWidgetState extends State<VehicleInsuranceWidget> {
  late VehicleInsuranceModel _model;
  ...
  void initState() {
    super.initState();
    fetchDLicense();
    _model = createModel(context, () => VehicleInsuranceModel());
  }
  ...
  Future<String?> fetchDLicense() async {
    ...
    if (response.statusCode == 200) {
      ...
      License = jsonResponse['data'][0]['insurance'];
      if (License!.isEmpty) {
        print('dLicenseBack is empty');
      } else {
        print(License);
      }
      return License;
