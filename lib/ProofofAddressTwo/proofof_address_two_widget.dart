...
import 'proofof_address_two_model.dart';
import 'package:new_minicab_driver/Data/api_service.dart';
export 'proofof_address_two_model.dart';

class ProofofAddressTwoWidget extends StatefulWidget {
  const ProofofAddressTwoWidget({super.key});

  @override
  State<ProofofAddressTwoWidget> createState() =>
      _ProofofAddressTwoWidgetState();
}

class _ProofofAddressTwoWidgetState extends State<ProofofAddressTwoWidget> {
  late ProofofAddressTwoModel _model;
  File? selectedImage;
  String? License;
  ...
  void initState() {
    super.initState();
    fetchDLicense();
    _model = createModel(context, () => ProofofAddressTwoModel());
  }
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            try {
                              var request = http.MultipartRequest(
                                'POST',
                                Uri.parse(ApiService.driverUploadPa2),
                              );
