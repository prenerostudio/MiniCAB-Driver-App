...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
  ...
  errorBuilder:
      (context, state) =>
          appStateNotifier.showSplashImage
              ? Builder(
                builder:
                    (context) => Container(
                      color: Colors.white,
  ...
  routes:
      [
          ...
          builder:
              (context, params) =>
                  params.isEmpty
                      ...
                      : NavBarPage(initialPage: 'Home', page: HomeWidget()),
        ),
        FFRoute(
          name: 'changepassword',
          path: '/changepassword',
        ...
        FFRoute(
          ...
          path: '/myprofile',
          builder:
              (context, params) => MyprofileWidget(
        ...
        FFRoute(
          ...
          path: '/jobshistory',
          builder:
              (context, params) => JobshistoryWidget(
                did: params.getParam('did', ParamType.String),
              ),
        ),
        FFRoute(
          ...
          builder:
              (context, params) => JobHistoryDetailsWidget(
                did: params.getParam('did', ParamType.String),
        ...
        FFRoute(
          ...
          path: '/paymentEntery',
          builder:
              (context, params) => PaymentEnteryWidget(
                jobid: params.getParam('jobid', ParamType.String),
                did: params.getParam('did', ParamType.String),
                fare: params.getParam('fare', ParamType.String),
              ),
          ...
          builder:
              (context, params) =>
                  params.isEmpty
                      ...
                      : NavBarPage(initialPage: 'Bids', page: BidsWidget()),
        ),
        FFRoute(
          name: 'AddVehicle',
          path: '/addVehicle',
        ...
        FFRoute(
          ...
          path: '/accountDetails',
          builder:
              (context, params) => AccountDetailsWidget(
        ...
        FFRoute(
          ...
          path: '/bidsHistory',
          builder:
              (context, params) => BidsHistoryWidget(
                did: params.getParam('did', ParamType.String),
              ),
        ),
        FFRoute(
          ...
          builder:
              (context, params) => NameFullScreenWidget(
        ...
        FFRoute(
          ...
          builder:
              (context, params) => OtpWidget(
                ...
                dropDownValue2: params.getParam(
                  'dropDownValue2',
                  ParamType.String,
                ),
              ),
        ...
        FFRoute(
          ...
          path: '/bidDetails',
          builder:
              (context, params) => BidDetailsWidget(
